...
namespace Entidades
{
    ...
    public class Manager : Companion, IOrdenable
    {
        ...
        /// <summary>
        /// Propiedad pública de lectura y escritura. Devuelve un string con el nombre del Manager.
        /// </summary>
        ...
        /// <summary>
        /// Propiedad pública de lectura y escritura. Devuelve un string con el nivel de acceso del Manager.
        /// </summary>
        ...
        #region Metodos
        /// <summary>
        /// Constructor público sin parámetros de la clase Manager. Inicializa su atributo nivel de acceso.
        /// </summary>
        public Manager() : base()
        {
            this.nivelDeAcceso = "Bajo";
        }
